...
<figure markdown="span">
  ![Three filmstrips showing the saccade-contingent paradigm: on a re-view trial the film jumps backward, on a skip-ahead trial it jumps forward, and on a no-change trial it continues, each triggered during an eye movement](../../assets/images/fig-jump-paradigm.png)
...
![Detection accuracy is lower for skip-ahead than rewind jumps](../../assets/images/fig-jumps.png)
