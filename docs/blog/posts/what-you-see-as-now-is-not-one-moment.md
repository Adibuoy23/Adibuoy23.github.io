---
title: What you see as "now" is not one moment
date: 2023-04-01
authors:
  - aditya
categories:
  - Perception
  - Time perception
slug: what-you-see-as-now-is-not-one-moment
description: >-
  The edge of your vision runs ahead of the center. That means the present
  moment you experience is stitched together from events that did not happen
  at the same time.
---
...
<figure markdown="span">
  ![Ian Phillips](../../assets/images/blog/ian-phillips.jpg){ .headshot }
  <figcaption><a href="https://philosophy.jhu.edu/directory/ian-phillips/">Ian Phillips</a><br><small>Philosophy, Johns Hopkins</small></figcaption>
</figure>
...
<figure markdown="span">
  ![Schematic of the task: a stream of letters at fixation, with a dot flashing briefly beside one of them](../../assets/images/blog/ecc-fig1-task.png){ width="480" }
...
<figure markdown="span">
  ![Two overlapping curves of participants' average errors: the ten-degree curve sits to the left of the two-degree curve](../../assets/images/blog/ecc-fig3-exp1-density.svg){ width="560" }
...
<figure markdown="span">
  ![Schematic of the second experiment: the dot flashes in the empty gap between two letters](../../assets/images/blog/ecc-fig4-exp2-task.png)
...
<figure markdown="span">
  ![Two curves of average errors: the ten-degree curve is centered near zero, the two-degree curve is shifted to the right](../../assets/images/blog/ecc-fig6-exp2-density.svg){ width="100%" }
...
<figure markdown="span">
  ![Schematic of the third experiment: letters on one side of fixation, dot on the other, both equally far from the cross](../../assets/images/blog/ecc-fig7-exp3-task.png)
...
<figure markdown="span">
  ![Two overlapping curves of average errors for one degree and five degrees, both centered in the same place](../../assets/images/blog/ecc-fig9-exp3-density.svg){ width="100%" }
...
<figure markdown="span">
  ![Animation: a spotlight of attention rests on the letter S in the stream, jumps out to a cue that appears in the periphery, and returns to the stream to find that the letter has already changed to V](../../assets/images/blog/ecc-attention-shift.gif){ width="560" }
...
<figure markdown="span">
  ![Schematic of the fourth experiment: a fixation cross with a disc at one of four possible positions along the horizontal axis](../../assets/images/blog/ecc-fig10-exp4-task.png)
...
<figure markdown="span">
  ![Bar chart: reproduced durations are longer for the twelve-degree disc than the three-degree disc, and closer to the true duration](../../assets/images/blog/ecc-fig12-exp4-bars.svg){ width="100%" }
