---
title: Where you look decides how many things you can track
date: 2021-02-01
authors:
  - aditya
categories:
  - Perception
  - Attention
slug: where-you-look-decides-what-you-can-track
description: >-
  Why some people are better than others at following several moving objects,
  and why the answer has more to do with the eyes than with "mental capacity."
---

# Where you look decides how many things you can track

<p class="post-dek" markdown>Some people can follow six moving things at once and others lose track at three. The usual story blames a limited mind. A model that borrows each person's eye movements tells a simpler one.</p>

![A tracking display shown sharp, and again blurred with distance from the point of gaze](../../assets/images/blog/eye-blur-illustration.png){ .post-hero }
...
<figure markdown="span">
  ![Simple eye diagram: light from the object you look at lands on the fovea, a small spot at the back of the retina; light from everything else lands in the periphery](../../assets/images/blog/fovea-vs-periphery.svg)
...
<figure markdown="span">
  ![Left: a tracking display with a dozen dots and a fixation cross. Right: the same display blurred progressively with distance from the cross](../../assets/images/blog/eye-blur-illustration.png)
...
<figure markdown="span">
  ![Three panels: targets flash yellow, all dots turn identical and move, participant clicks the targets](../../assets/images/blog/mot-fig1-trial.png){ width="560" }
...
<figure markdown="span">
  ![Tracking accuracy falls as speed increases and as the number of targets increases](../../assets/images/blog/mot-fig4-speed-load.png){ width="440" }
...
<figure markdown="span">
  ![Bar chart: about a quarter of fixation time on the target centroid, a fifth on objects, over half elsewhere](../../assets/images/blog/mot-fig6-fixation-class.png)
...
<figure markdown="span">
  ![Scatter plot: proportion of centroid fixations against participant rank and against accuracy, with weak correlations](../../assets/images/blog/mot-fig7-centroid-vs-rank.png)
...
<figure markdown="span">
  ![Task and model schematic](../../assets/images/fig-mot-schematic.png)
...
<figure markdown="span">
  ![Predicted versus observed accuracy and rank for 50 participants, both positively correlated](../../assets/images/blog/mot-fig11-predicted-vs-observed.png)
...
<figure markdown="span">
  ![Two panels of bell-shaped curves: for humans and for the model, the number of correctly chosen targets peaks around four regardless of how many were assigned](../../assets/images/blog/mot-fig10-human-vs-model-hist.png)
