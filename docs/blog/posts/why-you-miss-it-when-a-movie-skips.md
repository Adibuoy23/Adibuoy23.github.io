---
title: Why you miss it when a movie skips
date: 2024-05-01
authors:
  - aditya
categories:
...
description: >-
  ...
  backward and they notice more. Two studies on how vision papers over the gaps.
---

# Why you miss it when a movie skips

<p class="post-dek" markdown>Jump a film a full second forward during an eye movement and most people never notice. Jump it backward and they notice more often. Two studies on how vision papers over gaps in time, and why the direction matters.</p>

![Two timelines of six seconds of a film. The top one, what your eyes actually deliver, is broken by white gaps at every saccade and blink. The bottom one, what you experience, is a single unbroken bar.](../../assets/images/blog/eyes-vs-experience.png){ .post-hero }
...
<figure markdown="span">
  ![Schematic of the prediction engine: a model of the current event predicts the next moment, the prediction is compared with what the eyes deliver after a gap, a match keeps the model going and the world feels continuous, a mismatch marks an event boundary and the change is noticed](../../assets/images/blog/prediction-engine.svg){ width="100%" }
...
<figure markdown="span">
  ![Bar chart: detection accuracy is lower for skip-ahead than re-view jumps at both 500 and 1000 ms](../../assets/images/blog/jov-fig2-exp1.svg){ width="440" }
...
<figure markdown="span">
  ![Bar chart: at 1000 and 2000 ms jumps, re-view detection rises toward 95 percent while skip-ahead stays near 73 percent](../../assets/images/blog/jov-fig5-exp2.svg){ width="440" }
...
<figure markdown="span">
  ![Bar chart: optic flow similarity is positive for skip-ahead jumps and negative for re-view jumps at all three sizes](../../assets/images/blog/jov-fig8-optic-flow.svg){ width="100%" }
...
<figure markdown="span">
  ![Three panels: for skip-ahead jumps detection falls as optic flow similarity rises, for re-view jumps it rises](../../assets/images/blog/jov-fig9-detection-vs-flow.svg){ width="100%" }
...
<figure markdown="span">
  ![Schematic of the flicker paradigm: the screen flickers every two seconds for 150 ms, and during some flickers the film jumps forward or backward](../../assets/images/blog/app-fig1-flicker.png){ width="560" }
...
<figure markdown="span">
  ![Bar chart: about 44 percent detection for forward and 54 percent for backward jumps, with a false alarm line near 21 percent](../../assets/images/blog/app-fig2-exp1.svg){ width="100%" }
...
<figure markdown="span">
  ![Bar chart: about 43 percent detection for forward and 60 percent for backward jumps at 1000 and 2000 ms](../../assets/images/blog/app-fig4-exp2.svg){ width="100%" }
